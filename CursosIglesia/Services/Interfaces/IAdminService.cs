...
public interface IAdminService
{
    ...
    Task<ApiResponse<Guid>> CrearCategoriaAsync(CreateCategoryRequest request);
    Task<ApiResponse> ActualizarCategoriaAsync(Guid id, CreateCategoryRequest request);
    Task<ApiResponse> EliminarCategoriaAsync(Guid id);
    Task<FileUploadResponse> UploadImageAsync(MultipartFormDataContent content);
}
